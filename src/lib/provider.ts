...
import { 
    StringType, VoidType, Uint8ArrayType, AnyType, ErrorType, ReadableType,
    AsArray, AsRefNode, CreateParameter, CreateCall, CreateCallbackExpression, Method
} from './syntax';
...
class Decode extends Method {
    params = [
        ...
        CreateParameter('outputs', AsArray(StringType)),
    ];
    ret = AnyType;

    constructor() { super('decode') };
