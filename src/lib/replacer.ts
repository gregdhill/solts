...
export const Replacer = () => {
    ...
    return ts.createFunctionDeclaration(
        ...
        undefined,
        [
            CreateParameter(bytecode, StringType),
        ...
        ts.createBlock([
            ...
            DeclareConstant(
                truncated,
                CreateCall(
                    ts.createPropertyAccess(name, 'slice'),
                    [
            ...
            DeclareConstant(
                ...
                adds(
                    ...
                    arrayJoin(
                        ts.createSubtract(
                            ts.createNumericLiteral('37'),
                            ts.createPropertyAccess(truncated, 'length'),
                        ),
                        '_',
                    ),
                    ts.createStringLiteral('__'),
            ...
            ts.createWhile(
                ...
                ts.createExpressionStatement(ts.createAssignment(
                    bytecode,
                    CreateCall(
                        ts.createPropertyAccess(bytecode, 'replace'),
                        [label, address]
                    ),
                ))
            ),
