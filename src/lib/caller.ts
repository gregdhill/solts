...
import { 
    ...
    CreateNewPromise, CreateParameter, Uint8ArrayType, DeclareConstant, CreateCall, PromiseType, BooleanType 
} from "./syntax";
...
export const Caller = (provider: Provider) => {
    ...
    return ts.createFunctionDeclaration(
        ...
        ts.createBlock([
            ...
            ts.createIf(isSim, 
                ts.createReturn(CreateNewPromise([ts.createExpressionStatement(provider.methods.callSim.call(
                    client, 
                    payload, 
